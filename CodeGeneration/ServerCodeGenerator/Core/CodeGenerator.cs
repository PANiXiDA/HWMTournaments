...
internal static class CodeGenerator
{
    ...
    private static void Generate(INamedTypeSymbol model, JobConfig jobConfig, GeneratedFile layer)
    {
        ...
        var fileName = $"{NamingProvider.GetPrefix(layer)}{model.Name}{NamingProvider.GetSuffix(layer)}.cs";
        ...
        var status = !existed ? "создан" : (!jobConfig.OverwriteExisting ? "пропущен" : "перезаписан");
